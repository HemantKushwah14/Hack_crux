...
Command: npx gltfjsx@6.5.3 ./public/robot_playground.glb 
...
export default function Model(props) {
  ...
  useEffect(() => {
    if (actions && names.length > 0) {
      actions[names[0]]?.play(); // Play the first animation found
    }
  }, [actions, names]);
  return (
    <group ref={group} 
    // position={[-4.5, -2.5, 0]} 
    position={[-1,-2,-2]} 
    // rotation={[-0.01,Math.PI/2,-0.2]} 
    rotation={[0.05,Math.PI/4,-0.1]} 
